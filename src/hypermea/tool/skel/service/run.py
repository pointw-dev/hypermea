...
def stop_service(signum, frame):  # pylint: disable=unused-argument
...
def main():
    ...
    parser.add_argument('--host', help='The interface to bind to.  Default is "0.0.0.0" which lets you call the service from a remote location.  Use "localhost" to only allow calls from this location', default='0.0.0.0')
